...
public class AdapterPosts extends RecyclerView.Adapter<com.smc.smcsystem.AdapterPosts.MyHolder> {
    Context context;
    String myuid;
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        String status=modelPosts.get(position).getStatus();
        String area=modelPosts.get(position).getArea();
        ...
        holder.area.setText("Area: "+area+"cm.sq");
        ...
        holder.shareButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ModelPost cardData = modelPosts.get(position);
                Intent shareIntent = new Intent(Intent.ACTION_SEND);
                shareIntent.setType("text/plain");

                // Set the card data as the shared content
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, cardData.getTitle());
                shareIntent.putExtra(Intent.EXTRA_TEXT, "Complaint By: "+ cardData.getUname()+"\n\n"+"Complaint Title: "+cardData.getTitle() + "\n\n" +"Complaint Description: "+ cardData.getDescription()+ "\n\n" +"Complaint Status: "+ cardData.getStatus()+"\n\n" + cardData.getPcomments()+"\n\n"+"Complaint Likes: "+ cardData.getPlike());
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(holder.itemView.getContext(), ComplaintLikedByActivity.class);
        ...
        {
            holder.card.setBackgroundResource(R.color.colorGreen);
        }*/
...
//                PopupMenu popupMenu = new PopupMenu(v.getContext(), holder.more, Gravity.END);
...
//                });
    ...
    private void showMoreOptions(ImageButton more, String uid, String myuid, final String pid, final String image) {
        ...
        if (uid.equals(myuid)) {
            ...
            Toast.makeText(context, "You are not Aloud to perform more operations", Toast.LENGTH_LONG).show();
        }
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
   ...
   @Override
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView name, time, title, description, like, comments,status,area;
        ImageButton more;
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            card = itemView.findViewById(R.id.cardcom);
