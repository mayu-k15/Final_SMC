...
//        imagep = findViewById(R.id.commentimge);
        ...
        like.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComplaintDetailsActivity.this, ComplaintLikedByActivity.class);
    ...
    private void postComment() {
        ...
        if (TextUtils.isEmpty(commentss)) {
            Toast.makeText(ComplaintDetailsActivity.this, "Empty comment", Toast.LENGTH_LONG).show();
            return;
        }
        progressDialog.show();
        ...
        datarf.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(ComplaintDetailsActivity.this, "Added", Toast.LENGTH_LONG).show();
                comment.setText("");
                updatecommetcount();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(ComplaintDetailsActivity.this, "Failed", Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        myref.orderByChild("uid").equalTo(myuid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Glide.with(ComplaintDetailsActivity.this).load(mydp).into(imagep);
                    } catch (Exception e) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (uimage.equals("noImage")) {
                        ...
                        try {
                            Glide.with(ComplaintDetailsActivity.this).load(uimage).into(image);
                        } catch (Exception e) {

                        }
                    }
                    try {
                        Glide.with(ComplaintDetailsActivity.this).load(hisdp).into(picture);
                    } catch (Exception e) {
