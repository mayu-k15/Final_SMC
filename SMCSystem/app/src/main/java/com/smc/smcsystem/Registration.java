                ...
                if (task.isSuccessful()) {
                    ...
                    mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful())
                            {
                                Toast.makeText(Registration.this, "User Registered successfully, Please verify your mail ", Toast.LENGTH_LONG).show();
                            }
                            else
                            {
...
//                    Intent mainIntent = new Intent(Registration.this, DashboardActivity.class);
...
//                    startActivity(mainIntent);
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(Registration.this, "Error Occurred", Toast.LENGTH_LONG).show();
            }
        });
    }
    }
