                ...
                if (task.isSuccessful()) {
                    ...
                    if(mAuth.getCurrentUser().isEmailVerified()) {
                       ...
                       /* hashMap.put("phone", "");
                        ...
                        //  editor.apply();
                        Toast.makeText(UserLogin.this, "Registered User " + user.getEmail(), Toast.LENGTH_LONG).show();

                        Intent mainIntent = new Intent(UserLogin.this, DashboardActivity.class);
                        ...
                        Toast.makeText(UserLogin.this, "Please verify your Email", Toast.LENGTH_LONG).show();
                    }
                } else {
//                    loadingBar.dismiss();
