 ...
 * Use the {@link newComplaint#newInstance} factory method to
...
public class newComplaint extends Fragment {
    ...
    private static final String Key_="mobno";
            ...
            case CAMERA_REQUEST: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && writeStorageaccepted) {
                       ...
                       // ActivityCompat.requestPermissions(newComplaint.this, new String[]{Manifest.permission.CAMERA}, 101);
     ...
     * @return A new instance of fragment newComplaint.
     */
    // TODO: Rename and change types and number of parameters
/*    public static newComplaint newInstance(String param1, String param2) {
        newComplaint fragment = new newComplaint();
